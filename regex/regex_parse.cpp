    ...
    private: Node* getTokenBackslashAux(BackslashFlavor eFlavor)
    {
        ...
        case BackslashFlavor_Regex:
            ...
            for (
                ...
                p < &k_rgoZeroWidthMap[lengthof(k_rgoZeroWidthMap)];
                p++ )
            {
                if (p->m_wch == wch)
                {
        ...
        for (
            ...
            p < &k_rgoOneWidthMap[lengthof(k_rgoOneWidthMap)];
            p++ )
        {
            if (p->m_wch == wch)
            {
        ...
        for (
            ...
            pwch < &k_rgwchBackslashMap[lengthof(k_rgwchBackslashMap)];
            pwch += 2 )
        {
        ...
        unless (BackslashFlavor_Regex == eFlavor) return NULL;
